        ...
        <Card title="Next Steps">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <a href="/mint" className="block p-4 bg-dh-900 rounded-lg hover:bg-dh-700 transition-colors">
              <h4 className="font-medium text-white mb-1">Mint NFT</h4>
              <p className="text-sm text-dh-300">Upload an image to DataHaven and mint it as an NFT.</p>
            </a>
            <a href="/gallery" className="block p-4 bg-dh-900 rounded-lg hover:bg-dh-700 transition-colors">
              <h4 className="font-medium text-white mb-1">NFT Gallery</h4>
              <p className="text-sm text-dh-300">Browse, update, and manage your minted NFTs.</p>
            </a>
          </div>
        </Card>
      )}
